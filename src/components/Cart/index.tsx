...
const Cart = () => {
  const [isCarrinho, SetIsCarrinho] = useState(true)
    ...
    <CartContainer className= {isOpen ? 'is-open' : ''}>
      ...
      {isCarrinho ? (
        <Carrinho>
          ...
          <h4 onClick={() => SetIsCarrinho(false)}>Continuar com a entrega</h4>
        </Carrinho>
      ) : ( 
        <Checkout>
          {isSuccess ? (
            <Confirmacao>
                ...
                <DivBotoes>
                    <Button type="button" onClick={closeCart}>Concluir</Button>
                </DivBotoes>
            </Confirmacao>
            ) : (
                ...
                {isEntrega ? (
                    <Card>
                        ...
                        <DivBotoes>
                            ...
                            <Button type="button" onClick={() => SetIsCarrinho(true)}>Voltar para o Carrinho</Button>
                        </DivBotoes>
                    </Card>
                ) : (
                    <Card>
